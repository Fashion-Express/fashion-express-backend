...
`REQUIREMENTS.MD` is implemented, with 237 tests covering the business rules.
...
```bash
npm run test:db        # both suites below (237 tests)
npm run test:schema    # 58 constraint, trigger and error-message tests (Jest)
